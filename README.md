...
The ClassLocator Backend System is a Spring Boot-based backend that powers a class navigation system, students and faculty change or add classrooms information such as name or description of the room. It serves data related to classroom locations and maps while ensuring secure role-based access control using JWT authentication.
...
- Logs are created at **\src\Classlocator.log**
